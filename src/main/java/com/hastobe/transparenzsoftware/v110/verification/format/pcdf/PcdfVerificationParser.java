package com.hastobe.transparenzsoftware.v110.verification.format.pcdf;
...
import com.hastobe.transparenzsoftware.v110.verification.VerificationLogger;
...
import com.hastobe.transparenzsoftware.v110.verification.result.Error.Type;
	...
	public VerificationResult parseAndVerify(String data, byte[] publicKey) {
		...
		if (checkTwoBytePublicKeys(dtPK, publicKey))
		{
			...
			if (pos != -1)
			{
				...
				{
					com.hastobe.transparenzsoftware.v110.verification.result.Error er;
					er = new com.hastobe.transparenzsoftware.v110.verification.result.Error(Type.VALIDATION, "Signature verification failed", "error.pcdf.verification.signature.failed");
			...
			{
				com.hastobe.transparenzsoftware.v110.verification.result.Error er;
				er = new com.hastobe.transparenzsoftware.v110.verification.result.Error(Type.VALIDATION, "No signature present in data tupple", "error.pcdf.missing.signature");
				vr = new VerificationResult(verData, false);
				vr.addError(er);
			}
		}
		...
		{
			com.hastobe.transparenzsoftware.v110.verification.result.Error er;
			er = new com.hastobe.transparenzsoftware.v110.verification.result.Error(Type.VALIDATION, "Wrong Public Key", "error.invalid.public.key.embedded");
			vr = new VerificationResult(verData, false);
			vr.addError(er);
		}
