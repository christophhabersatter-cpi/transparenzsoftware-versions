...
import com.hastobe.transparenzsoftware.v110.verification.xml.Meter.TimeSyncType;
import com.hastobe.transparenzsoftware.v110.verification.xml.Meter.Type;
...
public class PcdfVerifiedData extends VerifiedData {
	...
	public PcdfVerifiedData(String pk, String chData)
	{
		...
		Meter first = new Meter(0.0, odt, Type.START, TimeSyncType.REALTIME,0);
		meters.add(first);
		
		OffsetDateTime odt2 = OffsetDateTime.parse(timeNormalizer(stopTime) + "+00:00");
		Meter met = new Meter(consDou, odt2, Type.STOP, TimeSyncType.REALTIME,0);
