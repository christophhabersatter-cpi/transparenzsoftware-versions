package com.hastobe.transparenzsoftware.v110.gui;

import java.awt.*;

public class Colors {

    public static final Color OPEN_FILE_BUTTON = new Color(209, 211, 212);
    public static final Color OPEN_FILE_BUTTON_HOVER = new Color(160, 164, 166);
    public static final Color HELP_BUTTON = new Color(209, 211, 212);
